  ...
  <Tab title="Cursor" icon="/images/logos/cursor.webp">
    <Steps>
      ...
      <Step title="Install agent skills">
        ...
        ```bash
        npx skills add https://github.com/SubframeApp/subframe --skills '*' -g --agent cursor --yes
        ```
      </Step>
      <Step title="Verify installation">
  ...
  <Tab title="Codex" icon="/images/logos/openai.png">
    <Steps>
      ...
      <Step title="Install agent skills">
        ...
        ```bash
        npx skills add https://github.com/SubframeApp/subframe --skills '*' -g --agent codex --yes
        ```
      </Step>
      <Step title="Verify installation">
