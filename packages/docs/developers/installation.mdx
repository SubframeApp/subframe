...
<AccordionGroup>
  <Accordion title="Installation issues">
    ...
    <Columns cols={2}>
      <Card title="Next.js" href="/framework-guides/nextjs" />
      <Card title="Vite" href="/framework-guides/vite" />
      <Card title="Astro" href="/framework-guides/astro" />
      <Card title="Monorepo" href="/framework-guides/monorepo" />
      <Card title="Other (manual installation)" href="/framework-guides/manual" />
    </Columns>
...
Your Subframe theme may use a Google Font or an uploaded font. You'll need to add a snippet to your codebase to render the fonts correctly.
...
See our [MCP server guide](/developers/guides/mcp-server) for more information on how to use the MCP server.
...
You can use our [MCP server](/developers/guides/mcp-server) to access your designs and documentation in your AI coding assistant and convert them to your preferred language and framework.
...
Join our active [Subframe Slack community](https://join.slack.com/t/subframecommunity/shared_invite/zt-380uma6dv-_lr7_bDLU5DJcoygfUYkeQ) for additional support from the Subframe team and other users.
