...
Subframe generates React code for your designs which you can export directly to [Bolt](/export-to-bolt), [Replit](/export-to-replit), [Cursor](/export-to-cursor), or [Lovable](/export-to-lovable) to speed up development. We've created prompts optimized for Bolt, or you can export manually.
