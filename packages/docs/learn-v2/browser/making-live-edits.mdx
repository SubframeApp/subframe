...
Use **Send** with Subframe's agent, or copy a prompt for another AI tool.

1. Click **Send** in the toolbar to give them to your Subframe agent
2. Click the change count in the toolbar, click **Copy prompt**, then paste the prompt into another AI tool
