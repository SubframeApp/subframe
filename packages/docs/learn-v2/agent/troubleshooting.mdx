...
Claude Code and Codex subscriptions require the Subframe [desktop app](/learn-v2/desktop-app).
...
The connected folder may have moved, been renamed, or be on a drive that is not mounted. Restore the folder at its original path or [change the connected folder](/learn-v2/agent/connecting-your-codebase#changing-the-connected-folder).
