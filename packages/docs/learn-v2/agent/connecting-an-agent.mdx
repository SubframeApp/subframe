...
[Agent chat](/learn-v2/agent/overview) works with Subframe AI credits or an existing Claude Code or Codex subscription.

To let the agent work in a local project, [connect your codebase](/learn-v2/agent/connecting-your-codebase).
...
Messages use the [Subframe AI credits included with your seat](/learn-v2/admin/pricing-and-plans#subframe-ai-credits).

## Connecting your Claude Code or Codex subscription

Connecting a subscription lets you use its models inside Subframe. This requires the [desktop app](/learn-v2/desktop-app).
