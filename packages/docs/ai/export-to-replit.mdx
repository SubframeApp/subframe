...
Subframe generates React code for your designs which you can export directly to [Replit](/ai/export-to-replit), [Bolt](/ai/export-to-bolt), [Cursor](/ai/export-to-cursor), or [Lovable](/ai/export-to-lovable) to speed up development. We've created prompts optimized for Replit, or you can export manually.
...
2. In Replit, modify the prompt as needed to:
    ...
    * [Add additional logic or connections](/developing/adding-business-logic)
