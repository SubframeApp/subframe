...
title: Supporting dark mode
<<<<<<< HEAD
description: Set up dark mode in your codebase using CSS variables and Tailwind.
>>>>>>> 0864317 (concepts images)
=======
>>>>>>> 2529c94 (theme section)
---
...
Add the theme script before React hydrates (see "Prevent flash" section above).
...
>>>>>>> 9d85cbd (accordions and card groups)
