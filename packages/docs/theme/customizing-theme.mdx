...
Your theme defines design tokens for your project to generate a Tailwind CSS configuration. Design tokens are reusable values for colors, typography, borders, corners, and shadows. Each project contains its own theme used across components and pages.
