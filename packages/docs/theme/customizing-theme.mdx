...
New tokens duplicate the properties from the frist token. Typography tokens auto-sort based on font size on the theme page.

### Changing font families

Click the font name card at the top to select a different font family. This updates all tokens using that font. Choose froma curated list of Google Fonts or custom uploaded fonts.
