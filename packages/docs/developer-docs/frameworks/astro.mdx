---
title: Astro
description: Install Subframe in Astro projects.
---
...
If you run into any issues with the installation, refer to the [manual installation guide](/developer-docs/frameworks/manual) for all of the steps needed to get Subframe working in your codebase.
```
