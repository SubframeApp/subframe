  ...
  <Tab title="Existing project">
    ...
    <AccordionGroup>
      <Accordion title="Installation issues">
        ...
        <Columns cols={2}>
          <Card title="Next.js" href="/developer-docs/frameworks/nextjs">

          </Card>
          <Card title="Vite" href="/developer-docs/frameworks/vite">

          </Card>
          <Card title="Astro" href="/developer-docs/frameworks/astro">

          </Card>
          <Card title="Monorepo" href="/developer-docs/frameworks/monorepo">

          </Card>
          <Card title="Other (manual installation)" href="/developer-docs/frameworks/manual">

          </Card>
        </Columns>
      </Accordion>
      <Accordion title="Importing existing components">
        If you have an existing component library, [import its theme first](/learn/theme/importing-tokens), then use the [Subframe MCP server](/developer-docs/guides/mcp-server) or the `/subframe:design` agent skill to recreate components and snippets one at a time.
      </Accordion>
    </AccordionGroup>
...
See our [MCP server guide](/developer-docs/guides/mcp-server) and [agent skills guide](/developer-docs/guides/skills) for more details.

## FAQ

<AccordionGroup>
  <Accordion title="What if I don't use React, TypeScript or Tailwind CSS?">
    You can use our [MCP server](/developer-docs/guides/mcp-server) to access your designs and documentation in your AI coding assistant and convert them to your preferred language and framework.
