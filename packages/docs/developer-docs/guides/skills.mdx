...
Agent skills are structured instructions that teach AI assistants how to use tools correctly. While the [MCP server](/developer-docs/guides/mcp-server) gives your AI the _ability_ to access Subframe, skills give it the _knowledge_ of how to use it well.
...
<AccordionGroup>
  <Accordion title="A skill can't be found or doesn't work as expected">
    ...
    1. Make sure the [MCP server](/developer-docs/guides/mcp-server) is running and connected
