...
For more complex accessibility needs, you can also add logic in the component's [wrapper `index.tsx`](/developer-docs/concepts/syncing-components#wrapping-components) for code reuse.
