...
For reusable test IDs, add them in the component's [wrapper `index.tsx`](/developer-docs/concepts/syncing-components#wrapping-components) so they're included by default.
