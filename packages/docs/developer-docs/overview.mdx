...
3. **Install Subframe** — Run the [CLI setup](/developer-docs/installation) in your codebase and choose where your components should live.
...
Components stay connected to Subframe through the CLI. Pages follow a different path: design them with your shared components, then implement them in your app with **Agent chat** or copy their code from Subframe. See the [design-to-code workflow](/developer-docs/concepts/design-to-code) for the full process.

Next, [install Subframe in your codebase](/developer-docs/installation).
