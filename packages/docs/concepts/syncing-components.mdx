...
The flexibility of slots lets you pass handlers, custom icons, or even swap in entirely different components. You can create [slots <Icon className="mb-1" size={12} icon="arrow-up-right-from-square" />](https://www.youtube.com/watch?v=7C9cRkvKbQY) using Subframe's component editor.
