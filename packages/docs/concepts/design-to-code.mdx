...
When the designs are ready for handoff, the developer syncs `Button` and `SocialSignInButton` components to their codebase by running the following command:
