...
- **MCP server (recommended)** - install Subframe MCP server and ask your AI tool to integrate the page code directly using the [page link](/developers/guides/mcp-server#using-the-mcp-server).
