...
After [syncing the components](/syncing-components) to your repository, you can use a Subframe component in your code. Import it directly or use the import alias you set up during installation:
