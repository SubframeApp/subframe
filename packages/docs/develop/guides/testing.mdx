...
For reusable test IDs, add them in the component's [wrapper `index.tsx`](/develop/concepts/syncing-components#wrapping-components) so they're included by default.
