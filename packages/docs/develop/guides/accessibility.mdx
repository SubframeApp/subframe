...
For more complex accessibility needs, you can also add logic in the component's [wrapper `index.tsx`](/develop/concepts/syncing-components#wrapping-components) for code reuse.
