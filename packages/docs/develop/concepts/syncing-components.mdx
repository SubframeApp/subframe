...
See [Component directories](/develop/upgrading/component-directories) for the full layout and migration details.
...
- **The wrapper `index.tsx`** — the usual choice once you've added [wrapping logic](/develop/concepts/syncing-components#wrapping-components). Your wrapper is preserved, while `Button.tsx` keeps receiving Subframe's updates.
