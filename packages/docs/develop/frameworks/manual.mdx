...
description: Step-by-step guide to manually install Subframe without the CLI.
---

<Note>
  We recommend using `@subframe/cli@latest` to initialize your project. If you're troubleshooting issues, you can follow
