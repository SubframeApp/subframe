...
If you run into any issues with the installation, refer to the [manual installation guide](/develop/frameworks/manual) for all of the steps needed to get Subframe working in your codebase.
```
