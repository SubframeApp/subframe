...
<Note>
  ...
  information visit the [manual installation guide](/develop/frameworks/manual) and the framework guide for your
  frontend of choice.
</Note>
...
<Note>
  ...
  directories](/develop/upgrading/component-directories).
</Note>
