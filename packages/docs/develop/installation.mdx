  ...
  <Tab title="Existing project">
    ...
    <AccordionGroup>
      <Accordion title="Installation issues">
        ...
        <Columns cols={2}>
          <Card title="Next.js" href="/develop/frameworks/nextjs">

          </Card>
          <Card title="Vite" href="/develop/frameworks/vite">

          </Card>
          <Card title="Astro" href="/develop/frameworks/astro">

          </Card>
          <Card title="Monorepo" href="/develop/frameworks/monorepo">

          </Card>
          <Card title="Other (manual installation)" href="/develop/frameworks/manual">
