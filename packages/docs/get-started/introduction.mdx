...
Subframe is an AI-powered design tool for building product interfaces. Design visually with real UI components, generate designs with AI that understands your product, and export production-ready React code.
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="book" href="/get-started/quickstart">
    Create your first design and export to code in under 10 mins.
  </Card>
  <Card title="New project" icon="book" href="/installation/new-project">
