...
<AccordionGroup>
  ...
  <Accordion title="How does Subframe integrate with AI code tools?">
    You can use the Subframe [MCP server](/developing/mcp-server) to build with AI coding tools like Cursor or Claude Code.
  </Accordion>
  ...
  <Accordion title="Why do I not see my pages in my codebase after I sync?">
    Pages often require refactoring and additional business logic after export. For that reason, pages are never synced via CLI and always copy/pasted. For more information, see [Exporting code](/developing/exporting-code).
  </Accordion>
