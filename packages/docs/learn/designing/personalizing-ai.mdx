...
Each project has a system prompt to customize AI with context about your product and design guidelines. You can modify the prompt via the [Ask AI](/learn/designing/using-ai-to-design#ask-ai) toolbar.
