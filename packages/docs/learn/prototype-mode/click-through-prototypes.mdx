---
description: "Create click-through prototypes without AI."
title: "Interactions"
---

Interactions let you create click-through prototypes let you add navigation and interactions on click, hover, and right click in preview mode — without using AI.
