...
Prototypes let you build real web apps from your page designs, synced with your design system. They are created from screens on a [canvas](/learn/canvases/canvases) by chatting and adding annotations.
...
1. Create a new [canvas](/learn/canvases/canvases)
2. Design your screens in design mode
3. Add [annotations](/learn/prototype-mode/annotations) describing functionality
4. Click **Prototype** in navbar, or click **New prototype** under your canvas in the pages sidebar
