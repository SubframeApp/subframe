...
See [Installation](/developer-docs/installation) for detailed instructions on setting up Subframe in a new or existing project.
  ...
  <Step title="Install the MCP server">
    ...
    <Info>To learn more about the MCP server and its capabilities, see [MCP Server](/developer-docs/guides/mcp-server).</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Go to developer docs" icon="code" href="/developer-docs/overview">
