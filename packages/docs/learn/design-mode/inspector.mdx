...
- **[Variant overrides](/learn/components/component-variants)** — different values for component instances
...
For the full list, see [Keyboard shortcuts](/learn/editor/keyboard-shortcuts).
