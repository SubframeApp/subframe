...
<Note>Applying a theme preset will replace values in your current theme.</Note>
...
See [Importing tokens](/learn/theme/importing-tokens) to quickly add your own color tokens.
