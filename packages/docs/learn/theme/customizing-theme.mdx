...
A header above the Colors section shows the editable theme name and an **Add dark mode** / **Add light mode** button. Once dark mode is enabled, a **⋯** menu appears with **Remove dark mode** / **Remove light mode**. See [Dark mode](/guides/dark-mode) for details.
