...
Add dark mode to define separate light and dark values for your color tokens.

1. Click **Add dark mode** in the Colors section header
2. Each token shows light and dark values — edit the dark values to build your dark palette
3. Preview with the light/dark toggle in the toolbar

For more on designing with dark mode, see [Dark mode](/learn/theme/dark-mode). To add a toggle in your app, see the [Dark mode toggle](/guides/dark-mode) developer guide.
