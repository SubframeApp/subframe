...
When downgrading to Free, all your existing projects, pages, and components are retained, but you won't be to add new pages if over the Free plan limit.
