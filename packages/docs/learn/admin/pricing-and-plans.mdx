...
When downgrading to Free, all your existing projects, pages, and components are retained, but you won't be able to create new projects beyond the single project the Free plan allows.
