...
<Note>All team members, including Viewers, can create tokens and use the CLI to sync components into their codebase. Only Admins and Editors can push components or import designs back to Subframe.</Note>
