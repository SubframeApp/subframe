...
<a href="/learn/admin/managing-projects" className="text-inherit font-normal border-b-0">
...
<a href="/learn/components/creating-components" className="text-inherit font-normal border-b-0">
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start mb-8">
  <div>
