...
- **Adding interactions in code** — Let developers add business logic within your components. Learn more about [headless components](/develop/concepts/code-generation#headless-components).
