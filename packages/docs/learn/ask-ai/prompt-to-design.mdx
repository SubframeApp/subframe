...
<Accordion title="I can't edit components">
  ...
  element inside the component, then right-click or press <kbd>/</kbd> to open [quick actions](/learn/design-mode/quick-actions) and select **Ask AI to edit...**.
</Accordion>
...
<Accordion title="How do I undo changes?">
  ...
  multiple changes. You can also use [Version history](/admin/version-history) to restore a previous state.
</Accordion>
