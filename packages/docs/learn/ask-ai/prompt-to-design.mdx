...
Ask AI is for creating and updating designs. For adding interactivity and state, use [Prototype mode](/prototype-mode/overview).
...
After generating, send follow-up prompts or switch to <a href="/learn/design-mode">design mode</a> for manual edits. Each follow-up can reference the current page and previous generations.
...
- **[Edit specific element](/learn/ask-ai/inline-ask-ai)** — Use inline Ask AI to make targeted edits
...
Ask AI is great for generating new designs or making broad changes to your page. But for more targeted edits, you may want to use [Inline Ask AI](/learn/ask-ai/inline-ask-ai).
</Accordion>

<Accordion title="I can't edit components">
  Ask AI mode only works with pages. To edit components, use [Inline Ask AI](/learn/ask-ai/inline-ask-ai)—select an
  element inside the component, then right-click or press <kbd>/</kbd> and select **Ask AI to edit...**.
</Accordion>
