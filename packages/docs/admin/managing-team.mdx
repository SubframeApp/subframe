...
| **Viewer** | View designs and export code              | Free        |
...
Viewers can export code, sync components with the [CLI](/admin/auth-tokens), and connect a read-only [MCP server](/agent/mcp-server), but they cannot push changes back to Subframe.
