---
title: Component props and slots
---
...
Let's compare two implementations of the `<TrackCard />` component from the [previous example](/developing/adding-business-logic#example-2-a-complex-custom-component).
...
<Tip>
  ...
  component. The `<TrackCardWithSlots.FavoriteButton />` subcomponent is a good example of this in the example above.
</Tip>
