...
Subframe generates React code for your designs which you can export directly to [Lovable](/ai/export-to-lovable), [Bolt](/ai/export-to-bolt), [Replit](/ai/export-to-replit), or [Cursor](/ai/export-to-cursor) to speed up development. 
...
### Develop in Lovable
1. [Copy / paste](/developing/copy-paste-pages) the code for your pages from Subframe into the Lovable chat.
2. Develop your normally by chatting with AI in Lovable.

### Adding new components or updating your theme
1. [Sync](/developing/syncing-components) from Subframe again locally.
