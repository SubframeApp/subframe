...
<Note>
  We assume you've already set up Tailwind CSS v4 for your frontend app. If you haven't done so, follow the [Tailwind CSS v4](https://tailwindcss.com/docs/installation) guide.
</Note>
