---
title: Quick edits
description: Ask the agent in context to edit or insert specific elements.
---
...
3. Select **Ask agent to edit...**
4. Type what you want to change and press <kbd>Enter</kbd>

You can also make a quick edit from the floating toolbar. Select an element, type your change into the **Quick edit** input, and press <kbd>Enter</kbd>.
