...
{/* TODO: Update image — project context is now configured in project settings, not from the agent chat bar */}
...
The agent automatically references your existing designs when generating new ones. Three things influence AI in your project:
