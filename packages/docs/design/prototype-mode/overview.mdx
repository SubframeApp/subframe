...
Prototypes let you build real web apps from your page designs, synced with your design system. They are created from screens on a [canvas](/design/flows) by chatting and adding annotations.
...
1. Create a new [canvas](/design/flows)
