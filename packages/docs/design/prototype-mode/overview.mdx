...
Prototypes let you build real web apps from your page designs, synced with your design system. They are created from screens on a [canvas](/design/canvases) by chatting and adding annotations.
...
1. Click the **Share** button at the top of the Inspector panel
...
- If you need to create larger prototypes, try [exporting to code](/develop/installation) and using Claude Code, Cursor, or Codex
