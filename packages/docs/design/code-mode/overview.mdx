...
You can also edit the canvas in Code mode. Insert, move, and edit elements just like in [Design mode](/design/design-mode/adding-elements), and the code updates as you go.
