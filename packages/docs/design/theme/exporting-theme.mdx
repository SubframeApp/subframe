...
<img
  src="/images/theme/theme-tailwind-config.png"
  alt="Export dialog showing the generated Tailwind configuration with tabs for v3 and v4"
/>
...
When [dark mode](/developer-docs/guides/dark-mode) is enabled, the export includes additional dark mode overrides:
...
See [Installation](/developer-docs/installation) for CLI setup instructions.
