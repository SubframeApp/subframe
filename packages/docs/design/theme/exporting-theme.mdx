...
When [dark mode](/develop/guides/dark-mode) is enabled, the export includes additional dark mode overrides:
...
See [Installation](/develop/installation) for CLI setup instructions.
