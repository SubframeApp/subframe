...
<Frame>
  <img
    src="/images/design-mode/overrides.png"
    alt="Inspector showing a breakpoint override with a pink dot indicator"
  />
</Frame>
...
<AccordionGroup>
  <Accordion title="Why can't I override this property?">
    ...
    {/* prettier-ignore */}
    Overrides only work for styles that translate to CSS, so some properties without a CSS equivalent cannot have a
    breakpoint override.
  </Accordion>
</AccordionGroup>
