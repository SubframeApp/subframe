...
<Frame>
  <img
    src="/images/design-mode/tailwind-css-inspector.png"
    alt="The Tailwind CSS section in the Inspector showing a text input for adding custom classes"
  />
</Frame>
...
You can also use [quick edits](/design/ask-ai/making-quick-edits) to add custom classes. For example, ask "make this element position absolute" and it will apply the right Tailwind classes for you.
