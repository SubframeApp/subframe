...
These controls only affect how the instance renders in design mode and preview. Runtime state in generated code is controlled by your application — see [headless components](/developer-docs/concepts/code-generation#headless-components).
