...
- **Interactive when needed** — Some components like checkboxes and accordions have built-in interaction logic using `@subframe/core`, our Radix-based headless component library. Learn more about [headless components](/developer-docs/concepts/code-generation#headless-components).
...
For more information, see [syncing components](/developer-docs/concepts/syncing-components).
