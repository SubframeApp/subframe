...
- **Adding interactions in code** — Let developers add business logic within your components. See [adding interactive logic](/design/components/component-docs) for more.
