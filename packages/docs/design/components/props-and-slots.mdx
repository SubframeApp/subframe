...
- **Adding interactions in code** — Let developers add business logic within your components. Learn more about [headless components](/developer-docs/concepts/code-generation#headless-components).
