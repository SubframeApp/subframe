...
Page names can contain any characters, including spaces and symbols. When you [export a page](/developer-docs/concepts/exporting-pages), Subframe normalizes the name into a valid component name in the generated code.
