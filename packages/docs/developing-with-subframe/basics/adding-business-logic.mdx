...
<Tip>
  We've made a CodeSandbox project for the examples below so you can play around with the code. You can find it [here](https://codesandbox.io/p/devbox/subframe-spoofy-rw5wrj).
</Tip>
