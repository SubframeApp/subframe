...
A [canvas](/design/flows) is a collection of related pages (e.g. "Onboarding", "Checkout"). Canvas tools, parameters, and URLs use the name "flow".

| Tool            | Description                                          |
| --------------- | ---------------------------------------------------- |
| `list_flows`    | List all canvases                                    |
| `get_flow_info` | Get a canvas and its ordered pages                   |
| `delete_flow`   | Delete a canvas, optionally with the pages on it     |
