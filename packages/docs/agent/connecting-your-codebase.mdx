...
1. Open Agent chat
2. Click **Connect your codebase** above the chat box
...
If you don't have a codebase yet, create a starter project instead. It is a new React app built with Vite and Tailwind CSS, with your project's components and theme already synced.

1. Open Agent chat in a project with no connected codebase
2. Click **Use a starter project**
3. Choose where to save the new folder

Subframe creates the folder and connects it to your project.
