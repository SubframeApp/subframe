...
Sometimes your Subframe component has interactive elements like buttons or dynamic content. We recommend adding a slot for those scenarios. Read our [guide](/articles/developing/props-and-slots) on slots and composition.
