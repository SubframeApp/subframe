...
Let's compare two implementations of the `<TrackCard />` component from the [previous example](/articles/developing/adding-business-logic#example-2-a-complex-custom-component).
