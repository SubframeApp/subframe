...
Make sure to first [install Subframe](/articles/get-started/installation). To sync the code for all of your components to your codebase run the following command:
<CodeGroup>
...
See our best practices for when to [disable sync](/articles/developing/disabling-sync).
