...
Subframe generates React code for your designs which you can export directly to [Replit](/articles/building-ai/export-to-replit), [Bolt](/articles/building-ai/export-to-bolt), [Cursor](/articles/building-ai/export-to-cursor), or [Lovable](/articles/building-ai/export-to-lovable) to speed up development. We've created prompts optimized for Replit, or you can export manually.
