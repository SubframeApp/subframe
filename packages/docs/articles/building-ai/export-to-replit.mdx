...
Subframe generates React code for your designs which you can export directly to [Replit](/export-to-replit), [Bolt](/export-to-bolt), [Cursor](/export-to-cursor), or [Lovable](/export-to-lovable) to speed up development. We've created prompts optimized for Replit, or you can export manually.
