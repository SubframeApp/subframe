...
The MCP server lets AI tools like Claude Code and Cursor fetch your designs directly and even create new ones. Agent skills teach your AI assistant how to use Subframe well — setting up projects, designing pages, and implementing with business logic.
