  ...
  <Tab title="Existing project">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Importing existing components">
        ...
        Note: If you're interested in early access to importing your existing library, reach out to [support@subframe.com](mailto:support@subframe.com)
      </Accordion>
    </AccordionGroup>
  </Tab>
</Tabs>
...
During initialization, the CLI will guide you through a few prompts:

- **Project selection** — If you have multiple Subframe projects, you'll be prompted to select which one to connect. You can search by project name to find the right one.
- **Import alias** — Configure the import path for your Subframe components (e.g., `@/subframe`). If the alias changes, you'll be asked to confirm before updating your Subframe project settings.
- **Component directory** — Choose where synced components are saved in your codebase.
