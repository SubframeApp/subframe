...
<Tip>
  We've made a [CodeSandbox](https://codesandbox.io/p/devbox/subframe-spoofy-rw5wrj) project for the examples below so
...
<img src="/images/adding-business-logic/form-example-1.png" alt="Form Example 1" className="w-full" />
